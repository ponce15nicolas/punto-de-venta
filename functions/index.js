...
function instruccionSistemaIa() {
    return [
        ...
        "Para preguntas concretas sobre stock de un producto, revisá primero inventario.consultaStock. Si existe una sola coincidencia, respondé con stockActual y unidad. Si hay varias variantes posibles, listá brevemente cada coincidencia con su stock y pedí precisión solo si sigue siendo necesario. No uses stockBajo o reposicionSugerida para inferir el stock de productos que no aparecen allí.",
