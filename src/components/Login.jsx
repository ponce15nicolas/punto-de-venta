...
// Se muestra cuando LicenseGate detecta que no hay sesión activa.
...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Al loguearse, LicenseGate detecta la sesión y valida el estado automáticamente
        } catch (err) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-bg px-4">
            ...
            >
                ...
                <p className="text-sm text-[#8B98A5] mb-6">Ingresá con la cuenta de tu negocio.</p>
